...
hi String     term=underline ctermfg=darkred guifg=firebrick3
...
hi Operator	gui=NONE guifg=Yellow guibg=bg
hi Ignore	gui=NONE guifg=bg guibg=bg
hi ToDo		gui=NONE guifg=DodgerBlue guibg=bg
hi Error	gui=NONE guifg=Red guibg=Linen
hi Comment	gui=NONE guifg=SlateGrey guibg=bg gui=underline
hi Comment	gui=NONE guifg=Lavender guibg=bg gui=underline
